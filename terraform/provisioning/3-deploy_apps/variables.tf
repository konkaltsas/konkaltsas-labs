...
variable "virtual_network_name" {
  description = "Name for the existing Virtual Network Name where ADC is deployed in."
}

variable "management_subnet_name" {
  description = "Management subent where the web server interface will be created."
}

variable "server_subnet_name" {
  description = "Server subent where the web server interface will be created."
}
